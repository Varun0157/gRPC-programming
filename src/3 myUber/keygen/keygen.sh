...
openssl req -new -key server.key -out server.csr -subj "/C=US/ST=NJ/O=MyUber Server"
...
openssl req -new -key rider.key -out rider.csr -subj "/C=US/ST=NJ/O=MyUber Rider"
...
openssl req -new -key driver.key -out driver.csr -subj "/C=US/ST=NJ/O=MyUber Driver"
