...
type KNNServiceClient interface {
	FindKNearestNeighbors(ctx context.Context, in *KNNRequest, opts ...grpc.CallOption) (*KNNResponse, error)
}
...
func (c *kNNServiceClient) FindKNearestNeighbors(ctx context.Context, in *KNNRequest, opts ...grpc.CallOption) (*KNNResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(KNNResponse)
	err := c.cc.Invoke(ctx, KNNService_FindKNearestNeighbors_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KNNServiceServer interface {
	FindKNearestNeighbors(context.Context, *KNNRequest) (*KNNResponse, error)
...
func (UnimplementedKNNServiceServer) FindKNearestNeighbors(context.Context, *KNNRequest) (*KNNResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindKNearestNeighbors not implemented")
}
...
func _KNNService_FindKNearestNeighbors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(KNNRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KNNServiceServer).FindKNearestNeighbors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: KNNService_FindKNearestNeighbors_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KNNServiceServer).FindKNearestNeighbors(ctx, req.(*KNNRequest))
	}
...
var KNNService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindKNearestNeighbors",
